...
export default function Returns() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader title={t('returnsRefunds')} subtitle="Process customer returns & refunds" emoji="↩️" icon={<Undo2 className="h-6 w-6" />} actions={<><Button onClick={() => setDialogOpen(true)}><Plus className="h-4 w-4 mr-1" />{t('processReturn')}</Button></>} />
