...
export default function Products() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader title={t('products')} subtitle="Manage your kids clothing catalog" emoji="👗" icon={<Package className="h-6 w-6" />} actions={<><Button onClick={openCreate}><Plus className="h-4 w-4 mr-1" />{t('addProduct')}</Button></>} />
